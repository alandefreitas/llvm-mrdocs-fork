...
public:
  ...
  /// Clear the checked bit on destruction if \p Err still holds success.
  ~ErrorAsOutParameter() {
...
/// RAII helper that marks an Expected out-parameter as checked.
template <typename T>
...
public:
  ...
  /// Mark the Expected out-parameter unchecked again on destruction.
