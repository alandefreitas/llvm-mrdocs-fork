...
/// Named alignment policies for endian I/O helpers.
enum {
  /// Use the natural alignment of the value type.
  aligned = 0,
  /// Allow unaligned memory access when reading/writing.
  unaligned = 1
};
...
/// Helpers to read and write values with an explicit byte order.
namespace endian {
...
/// Unsigned integer type corresponding to \p value_type.
template <typename value_type>
