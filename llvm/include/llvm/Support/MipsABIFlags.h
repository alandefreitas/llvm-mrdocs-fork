...
namespace llvm {
/// Constants for the MIPS ABI flags structure and related GNU object tags.
namespace Mips {
...
enum AFL_FLAGS1 {
  AFL_FLAGS1_ODDSPREG = 1 ///< Odd single-precision floating-point registers used.
};

/// MIPS GNU object attribute tags.
enum {
  Tag_GNU_MIPS_ABI_FP = 4,  ///< Floating-point ABI used by this object file.
  Tag_GNU_MIPS_ABI_MSA = 8, ///< MSA ABI used by this object file.
};

/// Values for the fp_abi word of an ABI flags structure and for the
/// Tag_GNU_MIPS_ABI_FP attribute tag.
