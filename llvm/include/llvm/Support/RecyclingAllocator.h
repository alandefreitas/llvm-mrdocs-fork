...
public:
  /// Destroy the allocator and release recycled blocks to the wrapped allocator.
  ...
  /// Allocate storage for \c T from the recycler or the wrapped allocator.
  ///
  ...
  /// Print statistics for the wrapped allocator and recycler free list.
  void PrintStats() {
