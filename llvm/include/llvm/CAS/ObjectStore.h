...
class MemoryBuffer;
/// Type-erasing owning callable used by CAS APIs that accept callbacks.
...
class ObjectStore;
class ObjectProxy;
/// Cache mapping action keys to CAS object results. @seebelow
class ActionCache;
...
public:
  /// Default construction is deleted; use \c load to create a proxy.
  ObjectProxy() = delete;
