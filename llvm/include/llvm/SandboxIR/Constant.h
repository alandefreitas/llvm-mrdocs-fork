...
public:
  ...
  /// Check whether an authentication operation with key \p Key and.
  ///
  /// (possibly blended) discriminator \p Discriminator is known to be compatible with this ptrauth signed pointer.
