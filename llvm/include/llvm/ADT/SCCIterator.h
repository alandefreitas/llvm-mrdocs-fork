...
public:
  ...
  /// Advance to the next strongly connected component.
...
public:
  /// Construct an iterator that reorders \p InputNodes by edge weight.
  /// @param InputNodes Nodes of one strongly connected component.
