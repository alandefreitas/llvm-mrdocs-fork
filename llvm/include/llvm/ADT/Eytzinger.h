...
public:
  /// Const pointer iterator over the Eytzinger-ordered buffer.
  using iterator = const T *;
  /// Const pointer iterator over the Eytzinger-ordered buffer.
  using const_iterator = const T *;

  /// Construct an empty span with no backing data.
  EytzingerTableSpan() = default;
  /// Construct a span over \p NumEntries elements starting at \p Data.
  ///
  /// \param Data Pointer to the first element in Eytzinger order.
  /// \param NumEntries Number of elements in the buffer.
...
public:
  ...
  /// Build an Eytzinger table from \p Keys.
  ///
