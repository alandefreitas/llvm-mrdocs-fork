...
///
/// Maps each integer into an equivalence class numbered 0 .. M-1 once
/// compressed. Initially each integer is alone; \c join merges classes, and
/// \c compress numbers them compactly and freezes further edits.
class IntEqClasses {
