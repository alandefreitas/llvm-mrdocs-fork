...
public:
  /// Construct from little-endian 64-bit words covering \c NumBits bits.
  /// @param B Word array; unused high bits in the last word are masked off.
  ...
  /// @param Init Bit indices to set (must be less than \c NumBits).
