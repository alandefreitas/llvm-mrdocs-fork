...
/// Base-2 logarithm of \c e.
inline constexpr double log2e      = log2e_v<double>;
/// Base-10 logarithm of \c e.
...
struct from_range_t {
  /// Construct a \c from_range_t tag value.
