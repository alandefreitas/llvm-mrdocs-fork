...
///
/// Relies on an IntervalMap under the hood. Good for representing sets which
/// predominantly contain contiguous ranges. Bad for representing sets with lots
/// of gaps between elements.
///
...
public:
  /// Allocator type used by the underlying IntervalMap.
  ...
  public:
    ...
    /// Type of the set-bit index yielded by the iterator.
    using value_type = IndexT;
    /// Signed distance type between iterators.
    using difference_type = std::ptrdiff_t;
    /// Pointer to a value_type (unused for this iterator).
    using pointer = value_type *;
    /// Reference to a value_type (unused for this iterator).
  ...
  /// Dump the bitvector contents to the debug stream.
