...
public:
  /// Element type stored in insertion order.
  using value_type = typename Vector::value_type;
  /// Key type used by the uniqueness set.
  using key_type = typename Set::key_type;
  /// Mutable reference to a stored element.
  using reference = value_type &;
  /// Const reference to a stored element.
  using const_reference = const value_type &;
  /// Underlying set type used for uniqueness.
  using set_type = Set;
  /// Underlying vector type used for insertion order.
  using vector_type = Vector;
  /// Iterator over elements in insertion order (const; mutation is via SetVector APIs).
  using iterator = typename vector_type::const_iterator;
  /// Const iterator over elements in insertion order.
  using const_iterator = typename vector_type::const_iterator;
  /// Reverse iterator over elements in insertion order.
  using reverse_iterator = typename vector_type::const_reverse_iterator;
  /// Const reverse iterator over elements in insertion order.
  using const_reverse_iterator = typename vector_type::const_reverse_iterator;
  /// Unsigned size type for the SetVector.
  ...
  /// Insert every element of range \p R, preserving first-seen order.
  /// @param R Range of elements to insert.
  ...
  /// @param RHS Other SetVector to swap with.
