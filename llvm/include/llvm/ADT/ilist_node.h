...
/// Iterator type for \p OptionsT, selecting \a ilist_iterator_w_bits when
/// iterator bits are enabled and \a ilist_iterator otherwise.
template <class OptionsT, bool IsReverse, bool IsConst>
...
protected:
  ...
  /// Construct a node with unset prev/next links.
...
/// NodeAccess helpers fixed to a concrete \p OptionsT.
template <class OptionsT> struct SpecificNodeAccess : NodeAccess {
protected:
  /// Mutable pointer to a list element for these options.
  using pointer = typename OptionsT::pointer;
  /// Const pointer to a list element for these options.
  using const_pointer = typename OptionsT::const_pointer;
  /// Concrete intrusive node type for these options.
